...
public class Controller implements Initializable, ControllerInterface {
    ...
    private void playMusic(ActionEvent actionEvent) {
        File file = new File("C:/Users/zkooh/OneDrive/Área de Trabalho/myTunes'songs/MyTunes/01 - Margarethe (Original Mix).mp3");
    ...
    private void playNextSong (ActionEvent actionEvent) {
        File file = new File("C:/Users/zkooh/OneDrive/Área de Trabalho/myTunes'songs/MyTunes/01 - Heut' Abend hab' ich Kopfweh.mp3");
        System.out.println("file:" + file.toURI().toString());
        Media media = new Media(file.toURI().toString());
        MediaPlayer mediaPlayer = new MediaPlayer(media);
        mediaPlayer.play();
        ...
        private void playPreviousSong (ActionEvent actionEvent) {
            File file = new File("C:/Users/zkooh/OneDrive/Área de Trabalho/myTunes'songs/MyTunes/01 - Ich fang dir den Mond (Single Version).mp3");
            System.out.println("file:" + file.toURI().toString());
            Media media = new Media(file.toURI().toString());
            MediaPlayer mediaPlayer = new MediaPlayer(media);
            mediaPlayer.play();
